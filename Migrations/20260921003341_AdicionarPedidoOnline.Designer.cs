...
namespace CinemaAPI.Migrations
{
    ...
    [Migration("20260921003341_AdicionarPedidoOnline")]
    partial class AdicionarPedidoOnline
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CinemaAPI.Models.PedidoOnline", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PedidosOnline");
                });

            modelBuilder.Entity("CinemaAPI.Models.PedidoOnlineAssento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PedidoOnlineId", "AssentoId")
                        .IsUnique();

                    b.ToTable("PedidosOnlineAssentos");
                });
            ...
            modelBuilder.Entity("CinemaAPI.Models.PedidoOnlineAssento", b =>
                {
                    ...
                    b.HasOne("CinemaAPI.Models.PedidoOnline", "PedidoOnline")
                        .WithMany("Assentos")
                        .HasForeignKey("PedidoOnlineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Assento");

                    b.Navigation("PedidoOnline");
                });
